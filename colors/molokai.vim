...
hi IncSearch       guifg=#000000 guibg=#FD971F gui=bold
...
hi MatchParen      guifg=#FF8700 guibg=#626262 gui=bold
...
if &t_Co > 255
   if s:molokai_original == 1
      ...
      " hi CursorLine               ctermbg=235   cterm=none
      hi CursorLine               ctermbg=65    cterm=none
      hi CursorLineNr ctermfg=226 ctermbg=236   cterm=bold
   endif
   ...
   hi IncSearch       ctermfg=233  ctermbg=208 cterm=bold
   ...
   hi MatchParen      ctermfg=208 ctermbg=241 cterm=bold
